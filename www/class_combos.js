...
var Combos = function() {
	...
	var tab = ["0~Select a country...", "AX~Åland Islands", "AF~Afghanistan", "AL~Albania", "DZ~Algeria", "AS~American Samoa", "AD~Andorra", "AO~Angola", 
	           ...
	           "BO~Bolivia", "BA~Bosnia and Herzegovina", "BW~Botswana", "BV~Bouvet Island", "BR~Brazil", "BQ~British Antarctic Territory", 
	           "IO~British Indian Ocean Territory", "VG~British Virgin Islands", "BN~Brunei", "BG~Bulgaria", "BF~Burkina Faso", "BI~Burundi", "KH~Cambodia", 
	           "CM~Cameroon", "CA~Canada", "CT~Canton and Enderbury Islands", "CV~Cape Verde", "KY~Cayman Islands", "CF~Central African Republic", 
	           "TD~Chad", "CL~Chile", "CN~China", "CX~Christmas Island", "CC~Cocos [Keeling] Islands", "CO~Colombia", "KM~Comoros", "CG~Congo - Brazzaville", 
	           "CD~Congo - Kinshasa", "CK~Cook Islands", "CR~Costa Rica", "HR~Croatia", "CU~Cuba", "CY~Cyprus", "CZ~Czech Republic", "CI~Côte d’Ivoire", 
	           "DK~Denmark", "DJ~Djibouti", "DM~Dominica", "DO~Dominican Republic", "NQ~Dronning Maud Land", "EC~Ecuador", "EG~Egypt", "SV~El Salvador", 
	           "GQ~Equatorial Guinea", "ER~Eritrea", "EE~Estonia", "ET~Ethiopia", "FK~Falkland Islands", "FO~Faroe Islands", "FJ~Fiji", "FI~Finland", 
	           "FR~France", "GF~French Guiana", "PF~French Polynesia", "TF~French Southern Territories", "FQ~French Southern and Antarctic Territories", 
	           "GA~Gabon", "GM~Gambia", "GE~Georgia", "DE~Germany", "GH~Ghana", "GI~Gibraltar", "GR~Greece", "GL~Greenland", "GD~Grenada", "GP~Guadeloupe", 
	           "GU~Guam", "GT~Guatemala", "GG~Guernsey", "GN~Guinea", "GW~Guinea-Bissau", "GY~Guyana", "HT~Haiti", "HM~Heard Island and McDonald Islands", 
	           "HN~Honduras", "HK~Hong Kong", "HU~Hungary", "IS~Iceland", "IN~India", "ID~Indonesia", "IR~Iran", "IQ~Iraq", "IE~Ireland", "IM~Isle of Man", 
	           "IL~Israel", "IT~Italy", "JM~Jamaica", "JP~Japan", "JE~Jersey", "JT~Johnston Island", "JO~Jordan", "KZ~Kazakhstan", "KE~Kenya", "KI~Kiribati", 
	           ...
	           "MQ~Martinique", "MR~Mauritania", "MU~Mauritius", "YT~Mayotte", "FX~Metropolitan France", "MX~Mexico", "FM~Micronesia", "MI~Midway Islands", 
	           ...
	           "NF~Norfolk Island", "KP~North Korea", "VD~North Vietnam", "MP~Northern Mariana Islands", "NO~Norway", "OM~Oman", "PK~Pakistan", "PW~Palau", 
	           ...
	           "WS~Samoa", "SM~San Marino", "SA~Saudi Arabia", "SN~Senegal", "RS~Serbia", "CS~Serbia and Montenegro", "SC~Seychelles", "SL~Sierra Leone", 
	           "SG~Singapore", "SK~Slovakia", "SI~Slovenia", "SB~Solomon Islands", "SO~Somalia", "ZA~South Africa", "GS~South Georgia and the South Sandwich Islands", 
	           "KR~South Korea", "ES~Spain", "LK~Sri Lanka", "SD~Sudan", "SR~Suriname", "SJ~Svalbard and Jan Mayen", "SZ~Swaziland", "SE~Sweden", "CH~>Switzerland", 
